...
<link rel="stylesheet" href="<?php echo base_url() . 'resources/css/metisMenu.css'; ?>" />
...
<script src="<?php echo base_url() . 'bower_components/moment/min/moment.min.js'; ?>" type="text/javascript" ></script>
<script src="<?php echo base_url() . 'bower_components/bootstrap/dist/js/bootstrap.min.js'; ?>"></script>
<script src="<?php echo base_url() . 'bower_components/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js' ?>" type="text/javascript"></script>
...
<script src="<?php echo base_url() . 'resources/js/duration-picker.js'; ?>"></script>
